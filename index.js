...
app.post('/register', (req, res) => {
  ...
  userModel
    ...
    .then((user) => {
      console.log(encrypt3DES(req.body.name.toUpperCase(), "vasanth"));
      if (user == null) {
        new userModel({
          name: encrypt3DES(req.body.name.toUpperCase(), "vasanth"),
          bloodGroup: encrypt3DES(req.body.blood.toUpperCase() + req.body.rh, "vasanth"),
          city: encrypt3DES(req.body.city.toUpperCase(),"vasanth"),
          phone: encrypt3DES(req.body.phone, "vasanth"),
          amount: encrypt3DES(req.body.amount || "0","vasanth"),
          address: encrypt3DES(req.body.address,"vasanth"),
        })
          .save()
          .then((user) => {
...
app.post('/donate', (req, res) => {
  ...
  userModel.findOne({ phone: req.signedCookies.user }, function (err, user) {
    ...
    user.amount += parseInt(parseFloat(req.body.amount));
    user
      .save()
